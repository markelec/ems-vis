...
from drawutils import draw_object_from_json, draw_line_from_json, draw_load_from_json, draw_generator_from_json, draw_transformer_from_json, draw_inverter_from_json
from diagram_data import bus1_json, bus2_json, line_json, line_json2, load_json, gen_json, trafo_json, inv_json   # Assuming this is your JSON data for the bus diagram
